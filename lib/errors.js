 ...
 */
class CheckLogsError extends Error {
 ...
 */
class ValidationError extends CheckLogsError {
 ...
 */
class ApiError extends CheckLogsError {
 ...
 */
class NetworkError extends CheckLogsError {
 ...
 */
function createErrorFromAxios(axiosError) {
