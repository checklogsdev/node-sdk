import CheckLogsClient from './client.mjs';
import { createRequire } from 'module';

// For compatibility with Node.js modules in ES environment
const require = createRequire(import.meta.url);

/**
 * CheckLogs Logger - ES Module version
 * Enhanced logging client with additional features
 */
export default class CheckLogsLogger extends CheckLogsClient {
  /**
